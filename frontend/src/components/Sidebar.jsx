...
const Sidebar = () => {
    return (
        <Flex direction={"column"} className='p-2 relative' bg={"#F4F6FA"}  >
            ...
            <div className='p-2 mt-2 w-full flex space-x-2 justify-center items-center'>
                ...
                <div>
                    <h1 className="text-black font-bold text-base xs:text-[14px] lg:text-[18px]">
                        Hamza Hashmi
                    </h1>
                    <p className='text-black text-sm xs:text-[12px] lg:text-[14px]'>hashmihamza846@gmail.com</p>
                </div>
                <div className=''>
            ...
            <div className='fixed bottom-0 w-[20%] xxxs:w-[100%] xxs:w-[85%] xs:w-[75%] md:w-[41.6%] lg:w-[26%] xl:w-[20%] xxxs:-ml-8 lg:-ml-2 h-[130px] pt-1 pl-3 bg-[#F4F6FA] border border-t-1 border-t-gray-300'>
